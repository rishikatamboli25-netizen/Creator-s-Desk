...
const Profile = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-[calc(100vh-89px)] flex items-center justify-center tracking-widest uppercase text-sm text-creator-muted">
        Loading Dashboard...
      </div>
    );
  }
  ...
  return (
    <main className="min-h-[calc(100vh-89px)] bg-creator-surface p-8 md:p-12 lg:p-16 relative">
        ...
        <div className="md:col-span-1 flex flex-col">
          <div className="flex items-center gap-4 mb-10">
            ...
            <div className="overflow-hidden">
              <p className="text-sm font-bold text-creator-black truncate">
                {user?.phone}
              </p>
              <p className="text-xs text-creator-muted mt-0.5 truncate">
